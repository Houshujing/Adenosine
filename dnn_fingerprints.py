...
input_filename = '/data/home/jianping/Desktop/adenosine/input_data.csv'

# output_filename = '../../data/temp/solubility_control_fingerprints_'+str(num_bits)+'_1.csv'
output_filename = '/data/home/jianping/Desktop/adenosine/dnn/output/fingerprint/dnn_fingerprints_' + str(num_bits) + '.csv'
